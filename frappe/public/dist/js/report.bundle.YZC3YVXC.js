(() => {
      ...
      if (frappe.model.can_export(this.doctype)) {
        items.push({
          ...
          action: () => {
            ...
            const d = frappe.report_utils.get_export_dialog(__(this.doctype), extra_fields, (data) => {
  ...
  frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
    ...
    prepare_columns(columns) {
      return columns.map((column) => {
        ...
        return Object.assign(column, {
          ...
          editable: false,
          compareValue: compareFn,
          format: (value, row, column2, data, for_filter = false) => {
            if (for_filter && (column2 == null ? void 0 : column2.fieldtype) === "Link") {
              return value || "";
            }
    ...
    export_report() {
      ...
      this.export_dialog = frappe.report_utils.get_export_dialog(__(this.report_name), extra_fields, ({ file_format, include_indentation, csv_delimiter, csv_quoting }) => {
    ...
    get_export_dialog(report_name, extra_fields, callback) {
      ...
      function update_csv_preview(dialog2) {
        ...
        PREVIEW_DATA = [
          ...
          ...report.data.slice(0, 3).map((row) => columns.map((col) => row[is_query_report ? col.fieldname : col.field]))
        ];
        dialog2.set_value("csv_preview", frappe.report_utils.get_csv_preview(PREVIEW_DATA, dialog2.get_value("csv_quoting"), dialog2.get_value("csv_delimiter")));
      }
 ...
 * @license MIT
 */
//# sourceMappingURL=report.bundle.YZC3YVXC.js.map
