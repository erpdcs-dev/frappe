...
`;
  ...
  frappe.views.ListView = class ListView extends frappe.views.BaseList {
    ...
    get_column_html(col, doc) {
      ...
      let translated_doctypes = ((_a = frappe.boot) == null ? void 0 : _a.translated_doctypes) || [];
    ...
    setup_realtime_updates() {
      ...
      frappe.realtime.on("list_update", (data) => {
        ...
        frappe.utils.debounce(this.process_document_refreshes.bind(this), 1e3)();
      });
...
//# sourceMappingURL=list.bundle.DJ2OEQQQ.js.map
